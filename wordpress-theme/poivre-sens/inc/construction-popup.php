...
function ps_construction_defaults() {
    return [
        ...
        'ps_cp_lede'     => __('Le nouveau site arrive bientôt. En attendant, laissez-nous votre e-mail pour rester en lien : ateliers, stages et nouvelles rares.', 'poivre-sens'),
